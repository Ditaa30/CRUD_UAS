...
<head>
    ...
    <style>
        ...
        /* Efek warna pada baris tabel saat diklik */
        table tbody tr:active {
            background-color: #ff6f92; /* Warna latar belakang saat diklik */
            color: #fff; /* Teks putih saat diklik */
...
<body>
    ...
    <div class="container mt-5 pt-5">
        <h2 style="text-align: center; font-size: 2.5rem; font-weight: bold; color: #333;">Daftar Minuman</h2>
